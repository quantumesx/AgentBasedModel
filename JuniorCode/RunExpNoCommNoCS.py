"""
Run the experiment under no comm sensors + no comm_self connection condition.
...
e = experiment(condition='no_comm', comm_self_connected=False,
               run_num=run_num, first_gen=first_gen, today=today,
               pop=pop, gen=gen, trial_num=trial_num, include_top=top)

if __name__ == '__main__':
    e.run()
    e_filename = 'Data/{}_comm_no_cs_disconn_Run{}.exp'.format(today, run_num)
